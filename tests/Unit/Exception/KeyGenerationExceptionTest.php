 ...
 * 密钥生成异常测试
 */
class KeyGenerationExceptionTest extends TestCase
{
    /**
     * 测试异常可以正常实例化
     */
    ...
    {
        $exception = new KeyGenerationException('Key generation failed', 100);
    ...
    public function test_canAcceptPreviousException(): void
    {
        ...
        $exception = new KeyGenerationException('Key generation failed', 0, $previous);
