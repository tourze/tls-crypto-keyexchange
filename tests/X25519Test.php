 ...
 * @internal
 */
#[CoversClass(X25519::class)]
final class X25519Test extends TestCase
{
    /**
     * 测试获取算法名称
     */
     ...
     * 测试生成密钥对
     */
    public function testGenerateKeyPairReturnsValidKeyPair(): void
    {
        $x25519 = new X25519();
     ...
     * 测试使用无效私钥长度时抛出异常
     */
    public function testComputeSharedSecretWithInvalidPrivateKeyLengthThrowsException(): void
    {
        $x25519 = new X25519();
        $keyPair = $x25519->generateKeyPair();
     ...
     * 测试使用无效公钥长度时抛出异常
     */
    public function testComputeSharedSecretWithInvalidPublicKeyLengthThrowsException(): void
    {
        $x25519 = new X25519();
        $keyPair = $x25519->generateKeyPair();
     ...
     * 测试不同私钥和公钥生成不同的共享密钥
     */
    public function testDifferentKeyPairsGenerateDifferentSharedSecrets(): void
    {
        $x25519 = new X25519();
